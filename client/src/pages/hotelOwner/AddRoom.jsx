  ...
  return (
    ...
    <div className='w-full flex max-sm:flex-col sm:gap-4 mt-4'>
      ...
      <div>
        ...
        <input type='number' placeholder='0' className='border border-gray-300 mt-1 rounded p-2 w-24' value={inputs.pricePerNight} onChange={e=>setInputs({...inputs, pricePerNightL: e.target.value})}/>
      </div>


    </div>

    <p className='text-gray-900 mt-4'>Amenities</p>
