...
const AllRooms = () => {
  ...
  const {rooms, navigate, currency}= useAppContext()
    ...
    //filter and sort rooms based on  the selected filter and sort options
    const filterRooms = useMemo(()=>{
      return rooms.filter(room => matchesRoomType(room) && matchesPriceRange(room) && filterDestination(room)).sort(sortRooms);

    },[rooms, selectedFilters, selectedSort.searcParams])
  ...
  return (
    <div className="flex flex-col-reverse lg:flex-row items-start justify-between pt-28 md:pt-35 px-4 md:px-16 lg:px-24 xl:px-32">
      {/* left side for displaying all rooms  */}
      <div>
      ...
      {/*Right side for filters, search, etc. */}
      <div className="bg-white w-80 border border-gray-300 text-gray-600 max-lg:mb-8 min-lg:mt-16 lg:ml-20 xl:ml-32">
